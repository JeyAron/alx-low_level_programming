...
/**
 * create_xarray - creates an array of char and initializes with x. adds a
 * termianting null byte.
 * @size: size of array to be initialized
 * Description: if there is insufficient spaces the function exits with
 * a status of 98
 ...
 * Description: if c is a non-zero digit, the function exits with a status of
 * 98
 ...
 * Description: if the number of arguments is incorrct or one number contains
 * non-digit , the function exits with a status of 98
 * Return: always 0
 */
